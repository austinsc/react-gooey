...
export default class StringField extends Component {
  static displayName = 'StringField';
  static propTypes = {
  ...
  render() {
    const {schema, name, uiSchema, idSchema, formData, required, disabled, readonly, autofocus, onChange, onBlur, registry = getDefaultRegistry()} = this.props;
